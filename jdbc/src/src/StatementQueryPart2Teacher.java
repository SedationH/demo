 ...
 */
public class StatementQueryPart2Teacher {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException, SQLException {
        ...
        /**
         * SQL分类: DDL(容器创建、修改、删除) DML（传入、修改、删除） DQL（查询） DCL（权限控制） TPM（事务处理）
         *
         *  executeQuery(DQL语句)  返回值：ResultSet 结果集对象
         *  executeUpdate(非DQL语句) 返回值：int 响应行数
         */
